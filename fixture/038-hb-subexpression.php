...
'funcs' => Array(
    ...
    return ''.$cx['funcs']['ch']($cx, 'helper1', Array(Array(((is_array($in) && isset($in['url'])) ? $in['url'] : null),$cx['funcs']['ch']($cx, 'helper1', Array(Array(((is_array($in) && isset($in['url2'])) ? $in['url2'] : null),((is_array($in) && isset($in['text'])) ? $in['text'] : null)),Array()), 'raw')),Array()), 'raw').'
';
}
?>